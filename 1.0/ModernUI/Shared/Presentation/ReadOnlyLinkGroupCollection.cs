...
namespace ModernUI.Presentation
{
        ...
        : ReadOnlyObservableCollection<LinkGroup>
    {
        ...
        /// </summary>
        /// <param name="list">
        ///     The <see cref="LinkGroupCollection" /> with which to create this instance of the
        ///     <see cref="ReadOnlyLinkGroupCollection" /> class.
        /// </param>
        ...
        /// </summary>
        internal LinkGroupCollection List { get; }
    }
}